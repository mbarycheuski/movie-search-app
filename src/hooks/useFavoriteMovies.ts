...
const useFavoriteMovies = () => {
  ...
  return {
    movies,
    updateFavoriteWatchStatus,
    addFavorite,
    removeFavorite,
    checkFavorite,
    updateFavoritePersonalDetails,
  };
};
